...
#   http://localhost:$PORT/leaderboard/            leaderboard (ARC-AGI-3)
#   http://localhost:$PORT/leaderboard/?comp=arc2  leaderboard (ARC-AGI-2)
PORT=4839
...
echo "  leaderboard (ARC-AGI-3): http://localhost:$PORT/leaderboard/"
echo "  leaderboard (ARC-AGI-2): http://localhost:$PORT/leaderboard/?comp=arc2"
